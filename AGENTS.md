...
Peerivo GEO is the central deterministic web-discovery/AEO/GEO checker for Peerivo public web products.

## Required context

Read `PROJECT.md` before making changes. The global Peerivo contract, once approved in `Peerivo/constitution`, is upstream authority and cannot be weakened here.
